...
public class ColumnFamily {
  ...
  /**
   * @param rowCacheSavePeriod
   *          the rowCacheSavePeriod to set
   */
  ...
  /**
   * @param keyCacheSavePeriod
   *          the keyCacheSavePeriod to set
   */
  ...
  /**
   * @param readRepairChance
   *          the readRepairChance to set
   */
  ...
  /**
   * @param memtableOperations
   *          the memtableOperations to set
   */
  ...
  /**
   * @param memtableThroughput
   *          the memtableThroughput to set
   */
  ...
  /**
   * @param memtableFlushAfter
   *          the memtableFlushAfter to set
   */
   ...
   *          the defaultValidationClass to set
   */
  ...
  /**
   * @param minCompactionThreshold
   *          the minCompactionThreshold to set
   */
  ...
  /**
   * @param maxCompactionThreshold
   *          the maxCompactionThreshold to set
   */
